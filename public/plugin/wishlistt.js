      ...
      function Config() {
        ...
        if (CONFIG.placement) {
          ...
          if (side !== 'right' && side !== 'left') {
            this.errors.push('invalid placement.side value');
          } else {
            placement.side = side;
          }
          top = CONFIG.placement.top;
          if (!top.match('[0-9]+.*')) {
            this.errors.push('invalid placement.top value');
          } else {
            placement.top = top;
          }
        }
...
(function() {
  define('urlResolve',[], function() {
    var resolve;
    return resolve = function(url, base_url) {
...
(function() {
  define('detect',['zepto'], function($) {
    var android, bb10, blackberry, browser, chrome, firefox, ie, ipad, iphone, ipod, kindle, os, osx, playbook, rimtabletos, safari, silk, touchpad, ua, webkit, webos, webview, wp;
    os = {};
    browser = {};
    ...
    os.phone = !!(!os.tablet && !os.ipod && (android || iphone || webos || blackberry || bb10 || wp || (chrome && ua.match(/Android/)) || (chrome && ua.match(/CriOS\/([\d.]+)/)) || (firefox && ua.match(/Mobile/)) || (ie && ua.match(/Touch/))));
    return {
      os: os,
      browser: browser
    };
...
define('text!view/widget.html',[],function () { return '<iframe\n    id="wishlistt-widget"\n    src="http://localhost:3000/plugin/widget?pp=disable"\n    frameBorder="0"\n    style="position: fixed; width: 180px; height: 44px;">\n</iframe>\n';});


define('text!view/iframe.html',[],function () { return '<div id="wishlistt-iframe">\n    <style type="text/css">\n     #wishlistt-iframe {\n       position: fixed;\n       right: 0;\n       top: 0;\n\n       overflow: hidden;\n       height: 100%;\n       width: 100%;\n       z-index: 100000;\n     }\n\n     #wishlistt-iframe .wishlistt-container {\n       position: absolute;\n       top: 0;\n       right: -350px;\n\n       height: 100%;\n     }\n\n     #wishlistt-iframe .wishlistt-container iframe {\n       position: absolute;\n       right: 0;\n\n       width: 350px;\n       height: 100%;\n     }\n\n     #wishlistt-iframe .wishlistt-close {\n       position: absolute;\n       right: 330px;\n       top: 5px;\n\n       color: white;\n\n       font-family: Arial;\n       font-weight: bold;\n       font-size: 13px;\n\n       cursor: pointer;\n     }\n\n     #wishlistt-iframe .wishlistt-background {\n       position: absolute;\n\n       width: 100%;\n       height: 100%;\n\n       background-color: grey;\n     }\n\n     #wishlistt-iframe .wishlistt-sidebar .wishlistt-spinner {\n       position: absolute;\n       right: 50%;\n       top: 50%;\n     }\n\n     #wishlistt-iframe .wishlistt-sidebar .wishlistt-spinner img {\n       margin: -15px 0 0 -15px;\n     }\n\n     #wishlistt-iframe .wishlistt-sidebar {\n       position: absolute;\n       right: 0;\n       top: 0;\n\n       width: 350px;\n       height: 100%;\n\n       background-color: whitesmoke;\n     }\n    </style>\n\n    <div class="wishlistt-background"></div>\n\n    <div class="wishlistt-container">\n        <div class="wishlistt-sidebar">\n            <div class="wishlistt-spinner">\n                <img src="http://localhost:3000/assets/spinner.gif"/>\n            </div>\n        </div>\n\n        <iframe src="http://localhost:3000/plugin?pp=disable" frameBorder="0"></iframe>\n\n        <div class="wishlistt-close">X</div>\n    </div>\n</div>\n';});
...
;
define("zeptoFxMethods", function(){});
...
(function() {
  require(['zepto', 'Config', 'urlResolve', 'detect', 'text!view/widget.html', 'text!view/iframe.html', 'zeptoFx', 'zeptoFxMethods'], function($, Config, urlResolve, detect, widgetTemplate, iframeTemplate) {
    return $(function() {
      ...
      iframeContainer.on('click', '.wishlistt-close, .wishlistt-background', function() {
      ...
      iframeElement.on('load', function() {
        ...
        return iframeElement.get(0).contentWindow.postMessage(JSON.stringify(payload), '*');
      });
      widgetElement = $(widgetTemplate);
      widgetElement.on('load', function() {
        var payload;
        payload = {
          wish: values,
          colors: Config.colors
        };
        return widgetElement.get(0).contentWindow.postMessage(JSON.stringify(payload), '*');
      });
